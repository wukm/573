...
\item $n=2$: We find a 
    ...
    \[
            y = p_2(x) := 0.55253769 + 1.32751256 \,x - 0.04145729\, x^2
        \]
...
\item   $y= bx^a$ form:
    ...
    linearized form of our target equation. Continue the mild derivation.

    The solution of the system is $p(x) = (1.8362676528) x^{0.708717475596}$
    \begin{figure}[p]
        \begin{center}
...
\begin{prob}
    ...
    \begin{figure}[p]
        \begin{center}
        \includegraphics[width=0.6\textwidth]{p3}
